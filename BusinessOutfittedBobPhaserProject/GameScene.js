...
//tests to see if bob touches a wall in x coord.
if(bobXCoord <= 32 || bobXCoord >= 448){
//calls upon our endGame function
this.endGame();
}
//tests to see if bob touches a wall in y coord
if(bobYCoord <= 32 || bobYCoord >= 568){
//calls upon the endGame function
this.endGame();
}
